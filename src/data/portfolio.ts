...
export const projects: Project[] = [
  {
    ...
    features: [
      ...
      { title:  '1,300만 건 상담 이력 기반 안내소 조회 성능 최적화',
        detail: [
          '공공기관 운영 환경에서 테이블 추가를 지양하는 제약을 고려하여 서버 기동 시 초기 적재 및 일일 증분 캐시 방식을 적용, 1,300만 건 상담 이력 기반 안내소 조회 시간을 2,360ms에서 1ms 미만으로 개선',
        ],
      },
    ],
  },
